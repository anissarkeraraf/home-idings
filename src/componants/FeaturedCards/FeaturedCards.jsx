...
const FeaturedCards = ({ home }) => {
    ...
    return (
        <div className="card bg-[#e9dbce] shadow-xl text-[#bc9874] hover:text-black transition duration-1000 ease-in-out hover:scale-110">
            ...
            <div className="card-body">
                ...
                <div className="card-actions mt-4">
                   <Link to={`/home/${id}`} className="btn btn-primary w-full">View Property</Link>
                </div>
            </div>
